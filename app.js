const itineraries = [
  { date:"9/11", weekday:"五", title:"天府機場 → 重慶", city:"移動日", lodging:"重慶", tone:"move", note:"爸媽 NX387 由天府機場 T1 於 15:50 起飛。約 14:00 在安檢口分開後前往成都東站；優先買 17:30–19:00 間直達重慶北的班次，沒合適座位才用 20:03 的加開車。", items:[
    ...
    ["抵達後","入住解放碑、附近吃飯","若搭晚班車就直接叫車入住，只吃便利商店或飯店附近宵夜，今晚不排景點。","重慶北站"]
  ]},
  { date:"9/12", weekday:"六", title:"老城夜景・週六音樂夜", city:"渝中＋江北", lodging:"重慶", tone:"city", note:"目前預報偏熱，戶外只放上午與傍晚，中間在來福士休息。晚上看完洪崖洞後，可選 9/12 的堅果 NUTS 19 週年音樂夜；這是整趟最適合自然認識人的一晚。", items:[
  ...
  { date:"9/13", weekday:"日", title:"博物館・輕軌・二廠", city:"渝中區", lodging:"重慶", tone:"city", note:"下午可能有陣雨，所以三峽博物館固定上午，李子壩與鵝嶺二廠視雨勢縮短。今晚提早回解放碑，替隔天武隆留體力。", items:[
  ...
  { date:"9/14", weekday:"一", title:"武隆喀斯特一日", city:"武隆", lodging:"重慶", tone:"hard", note:"週一博物館休館，正好去武隆。9 月景區入園時間至 16:30；目前預報上午可能有雨，因此正規一日團、雨具、防滑鞋與可取消條款都很重要。", items:[
  ...
  { date:"9/15", weekday:"二", title:"下浩里・南濱微醺夜", city:"渝中＋南岸", lodging:"重慶", tone:"flex", note:"武隆隔天上午完全留白。下午才搭長江索道、逛龍門浩與下浩里；晚上只選一間南濱路餐吧，不趕場。", items:[
  ...
  { date:"9/16", weekday:"三", title:"觀音橋・交朋友之夜", city:"江北區", lodging:"重慶", tone:"city", note:"目前預報有雨，所以民主村降為天氣乾燥才去；主線改成下午休息、傍晚北倉短走、方圓 LIVE 與觀音橋室內活動，最後再選九街或紫薇路。", items:[
